...
* Add: Display name step.
* Add: LearnDash Steps to site assist if active.
* Improve: Preview size on smaller laptops.

= 2.2.8 =
Release Date: 29th April 2025
* Update: New AI layout release maple.
* Improve: AI text replace.
...
* Update: Improve form import.
* Fix: Issue with importing video file.

= 2.2.1 =
* Update: Improve GiveWP support in prep for 4.0

= 2.2.0 =
* Add: New Site Assist.
* Update: Improve GiveWP support.
* Update: Improve AI content input.

= 2.1.9 =
* Fix: Issue where AI wasn't connecting correctly.

= 2.1.8 =
* Fix: PHP warning

= 2.1.7 =
* Update: Support for Kadence Creative Kit

= 2.1.6 =
* Fix: Issue with importing when kadence blocks not active.
...
* Fix: Issue with some images repeating.
